...
```
# Values
RESOURCE_GROUP=policyTagDeny
POLICY_NAME=tag-deny
...
# Assign policy
az policy assignment create --display-name $POLICY_NAME --scope $SCOPE --policy $POLICY_NAME -p '{"tagName": {"value": "costCenter"}}'
```