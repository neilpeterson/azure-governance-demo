...
```
# Values
RESOURCE_GROUP=policyTagAppend
...
# Assign policy
az policy assignment create --display-name $POLICY_NAME --scope $SCOPE --policy $POLICY_NAME -p '{"tagName": {"value": "costCenter"},"tagValue": {"value": "headquarter"}}'
```